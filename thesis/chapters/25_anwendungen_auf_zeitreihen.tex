...
\begin{bem}[Weitere Metriken für Zeitreihenschätzungen]
...
Man kann Backtests auch sequenziell durchführen: Für jedes Jahr wird aus den vorherigen Jahren eine GBM kalibriert, die dann mit dem tatsächlichen Wert verglichen wird. Dies wird in Abbildung \ref{fig:dax_backtest_seq} gezeigt.
\end{bsp}
