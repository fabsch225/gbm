...
Aus der Unabhängigkeit der Inkremente folgt
$$
\begin{aligned}
...
\subsection{Die brownsche Bewegung als Grenzprozess und Eigenschaften}
...
\begin{enumerate}
  ...
  \item Verteilungskonvergenz von endlich-dimensionalen Vektoren und die Kovarianzen (Hieraus folgt bereits die Selbstähnlichkeit / Bedingte Verteilung so wie die Martingal-Eigenschaft)
...
\begin{bem}[Interpretation der Kovarianzen]
...
In der zweiten Grafik (mit Kovarianz-Struktur) kann man erkennen, dass die bedingten Verteilungen eine geringere Varianz haben, und jeweils um den Vorherigen Wert zentriert sind. Dies wird im Folgenden noch präzisiert.
Das kann man als ein schwaches Stetigkeits-Kriterium interpretieren.
