...
In der zweiten Grafik (mit Kovarianz-Struktur) kann man beobachten, dass die Varianz der Gauß-Kurven zum aktuellen Zeitpunkt kontinuierlich
abnimmt. Das kann man als ein Stetigkeits-Kriterium betrachten. (Obwohl man nicht direkt auf die Stetigkeit der Pfade folgern kann)
...
$$
für $Z\sim N(0,\sigma^2)$ und jedes $\varepsilon>0$
$$
P(|Z|>\varepsilon) \le 2\exp\!\Big(-\frac{\varepsilon^2}{2\sigma^2}\Big).
$$
Mit der Vereinigungsschranke folgt dann
$$
