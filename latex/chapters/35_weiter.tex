...
Die Schätzer für die Parameter erhält man durch Maximierung der Log-Likelihood:
$$
...
Die Quasi-Maximum-Likelihood-Schätzung für das CEV-Modell basiert auf der Approximation der Übergangsdichte durch das Euler-Maruyama-Schema. Die beobachteten Kursänderungen werden als normalverteilt angenommen, und die Parameter werden so gewählt, dass die beobachteten Daten unter dem Modell möglichst wahrscheinlich sind.
