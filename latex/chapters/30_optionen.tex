...
\begin{satz}[Satz von Pratt, \cite{elstrod} S. 280, vereinfacht]
...
\\ \textit{Beweis}\footnote{Der Beweis ist angelehnt an die Argumentation in \cite{hull}, S. 347}. Risikoneutrale Bewertung im Binomialmodell liefert
$$
