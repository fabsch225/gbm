...
\end{enumerate}
Die so konstruierte Strategie ist selbstfinanzierend und repliziert die Option exakt.
 Der Startpreis $C_0$ ist eindeutig und fällt mit der risikoneutralen Bewertung zusammen.
\end{satz}
