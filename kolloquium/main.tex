...
\begin{frame}{Risikoneutrale Bewertung von Optionen}
  \begin{itemize}
      \item Unterschiedliche Investoren haben unterschiedliche Risikopräferenzen
      \item Modellannahme risiko-neutrale Welt: Der Investor braucht keine Prämien (Anreize) um riskante Positionen einzugehen
      \item Das Bankkonto hat in der physikalischen Welt den Vorteil, das kein Risiko besteht.
      \item Interpretation: Der Trend der Aktie $\mu$ ist eine Risiko-Prämie.
  \end{itemize}
\end{frame}
